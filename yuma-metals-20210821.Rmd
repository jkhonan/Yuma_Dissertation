...
dim(tmp) ## 330 222 ##New data set has dim 330, 199 (after removal of identifiers and mental health data) #Also Pb208 is already the only one that is left of the lead columns
 names(tmp)
 ##  [1] "ID"                        "Mn55"                     
 ##  [3] "Cu65"                      "Cd111"                    
 ##  [5] "Hg202"                     "Pb206"                    
...
distributions are not as bad as I feared.  All are still right-skewed after
...
*Note* - Other BDL values are replaced with the limit of detection/sqrt(2).
