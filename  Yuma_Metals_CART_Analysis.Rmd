---
title: "Yuma_Metals_CART_Analysis"
author: "Jenna Honan"
date: "2023-07-18"
...
png("CART_Cu_plot.png", width=1200, height=800, res=300)
...
model.Cu.pruned <- prune(model.Cu, cp = 0.02)
par(xpd = NA) # otherwise on some devices the text is clipped
...
png("CART_Hg_plot.png", width=1200, height=800, res=300)
...
png("CART_Mn_plot.png", width=1800, height=800, res=300)
...
png("CART_Pb_plot.png", width=1200, height=800, res=300)
...
png("CART_U_plot.png", width=1800, height=800, res=300)
...
model.U.pruned <- prune(model.U, cp = 0.02)
par(xpd = NA) # otherwise on some devices the text is clipped
